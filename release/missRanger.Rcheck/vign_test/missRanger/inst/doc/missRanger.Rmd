...
- It can deal with most realistic variable types, even dates and times without destroying original data structure.

- It combines random forest imputation with predictive mean matching. This generates realistic variability and avoids "new" values like 0.3334 in a 0-1 coded variable. Like this, `missRanger` can be used for realistic multiple imputation scenarios, see e.g. [3] and [4] for the statistical background.
...
Everything was dealt with by `missRanger` except the list column.
