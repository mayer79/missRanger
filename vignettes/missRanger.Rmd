...
Since {missRanger} 2.4.0, setting `data_only = FALSE` returns not just the imputed data, but rather a "missRanger" object containing more information.

```r
imp <- missRanger(irisWithNA, data_only = FALSE)
